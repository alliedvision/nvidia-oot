...
/* SPDX-FileCopyrightText: Copyright (c) 2015-2026 NVIDIA CORPORATION & AFFILIATES.
 * All rights reserved.
 *
 *
...
#if defined(NV_VB2_BUFFER_STRUCT_HAS_WAIT_PREPARE_AND_FINISH)
	/* Removed in Linux v7.0 */
